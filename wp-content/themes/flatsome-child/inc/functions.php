...
function theme_tra_gop(){
    ...
    <div class="head-ins-products">
        <p class="mbl">
            ...
            <b>Giá máy <span class="text-price" id="price-tab-3">
        ...
        <div class="row">
            <div class="col medium-6 small-12 large-6 mbl">
                ...
                <div class="pvl phm"><div class="price-procent"></div></div>
            </div>
            <div class="col medium-6 small-12 large-6 mbl">
                <p><span class="fa-stack fa-2x">
                ...
                <div class="pvl phm"><div class="month-pay"></div></div>
                <p><b>Thời hạn 3 tháng chỉ áp dụng cho trả góp qua thẻ tín dụng hoặc Fecredit</b></p>
            </div>
        </div>
    </div>
                ...
                <div class="col medium-6 small-12 large-6">
                    <div class="left-ins-ft">
                        <div class="left-tragop">
                            ...
                            <img src="https://onewaymobile.vn/modules/installment/assets/images/tragop_02.png" class="img-responsive home-credit">
                            <img src="https://onewaymobile.vn/modules/installment/assets/images/tragop_04.png" class="img-responsive">
                        </div>
                        <ul>
                ...
                <div class="col medium-6 small-12 large-6">
                    <div class="right-ins-ft">
                        <div class="left-tragop">
                            ...
                            <img src="https://onewaymobile.vn/modules/installment/assets/images/tragop_07.png" class="img-responsive">
                        </div>
                        <div class="row mbl">
                            <div class="col medium-6 small-12 large-6">
                                <p><b>Chọn ngân hàng:</b></p>
                                <select class="form-control" name="bankId" id="bankId">
                                    <option value="" disabled="" selected="">Ngân hàng trả góp</option>
                                    ...
                                    <option value="22">VIETCOMBANK (Ngân hàng thương mại cổ phần Ngoại thương Việt Nam)</option>
                    ...
                    <div>
                        <ul>
                            ...
                            <li><b>Số tiền trả hàng tháng (VNĐ): <span id="auto-caculate"><i class="fas fa-sync fa-spin" id="loading-image"></i>0</span></b></li>
