...
class Client
{
    ...
    {
        $path = (null !== $driveItemId) ? 'drive/items/'.$driveItemId : 'drive/root';
    ...
    {
        $path = (null !== $driveItemId) ? 'drive/items/'.$driveItemId.'/children' : 'drive/root/children';
    ...
    {
        return $this->apiGet("drive/root")->createdBy->user;
    }
