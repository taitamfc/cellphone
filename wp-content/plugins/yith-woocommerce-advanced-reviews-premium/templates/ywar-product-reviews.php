...
?>
<?php do_action( 'yith_advanced_reviews_before_reviews', $product_id ); ?>
...
<div id="reviews" class="ywar-review-content">
	...
	<?php if ( ! $can_submit ) : ?>
		...
		<p class="woocommerce-verification-required">
			<?php echo wp_kses( apply_filters( 'ywar_product_reviews_submit_reviews_denied_text', esc_html__( 'Only logged in customers who have purchased this product may write a review.', 'yith-woocommerce-advanced-reviews' ), $product_id ), 'post' ); ?>
