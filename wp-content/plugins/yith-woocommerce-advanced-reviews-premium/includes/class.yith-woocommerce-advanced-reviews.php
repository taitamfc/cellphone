	...
	class YITH_WooCommerce_Advanced_Reviews {
		...
		public function submit_attachments( $review_id ) {
			...
			if ( $_FILES ) {
				...
				if ( ( $this->attachments_limit !== 0 ) && ( $this->attachments_limit > 0 ) && ( $files_count > $this->attachments_limit ) ) {
					return;
				}
		...
		public function display_plugin_metabox() {
			...
			<div class="woocommerce_options_panel">
				...
				<div class="ywar-author-info">
					...
					<?php do_action( 'ywar_metabox_before_author_info_fields' ); ?>
					...
					<?php do_action( 'ywar_metabox_after_author_info_fields' ); ?>
				</div>
			</div>
			<?php
			// Show thumbnails.
